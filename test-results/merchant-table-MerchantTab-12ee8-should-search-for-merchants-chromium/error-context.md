  ...
  - table:
    - rowgroup:
      - row "Business Status Risk Type Volume Transactions Metrics":
        ...
        - cell
    - rowgroup:
      - row "No data available Try adjusting your search":
        - cell "No data available Try adjusting your search":
          - img
          - paragraph: No data available
          - paragraph: Try adjusting your search
    - rowgroup:
      - row "Showing 1 to 0 of 0 merchants Show 10":
        - cell "Showing 1 to 0 of 0 merchants Show 10":
          - paragraph: Showing 1 to 0 of 0 merchants
          - text: Show
          - combobox:
            - option "10" [selected]
            - option "25"
